...
function VolumeSlider:render()
	...
	-- BG & FG paths
	local bg_path = create_nudged_path(0, 24 + self.border_size)
	local fg_path = create_nudged_path(self.border_size, 24, volume_y)

	-- Background
	ass:new_event()
	ass:append('{\\rDefault\\an7\\blur0\\bord0\\1c&H' .. serialize_rgba('c0c0c0').color ..
